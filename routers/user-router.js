...
router.post('/users/register', async (req,res) =>{
    ...
    try{
        ...
        res.set("Set-Cookie", `token1=${token}; HttpOnly; Path=/; SameSite=Lax; max-age=1209600;`)
...
router.post('/users/login', async (req,res) =>{
    ...
    res.set("Set-Cookie", `token1=${token}; HttpOnly; Path=/; SameSite=Lax; expires=${now.toUTCString()};`)
...
router.post('/users/logout', verifyToken,async (req,res) =>{
    ...
    res.set("Set-Cookie", `token1=rubbish; HttpOnly; Path=/; SameSite=Lax; expires=${dayjs().toDate()};`)
